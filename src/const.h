...
#define PIN_SPI1_SS0        39                         //! P3.2 X axes
#define PIN_SPI1_SS1        40                         //! P3.1 Y axes
#define PIN_SPI1_SS2        67                         //! not used
#define PIN_SPI1_SS3        65                         //! not used
#define PIN_SPI1_MOSI       37                         //! P0.1
#define PIN_SPI1_MISO       63                         //! P0.0
#define PIN_SPI1_SCK        38                         //! P0.10

// Pin selection for SPI2 on X2
#define PIN_SPI2_SS0        70                         //! P0.14 Z axes
#define PIN_SPI2_SS1        72                         //! P0.7 A axes
#define PIN_SPI2_SS2        73                         //! P1.2 C/CR axes
#define PIN_SPI2_SS3        71                         //! P3.14 B/CL axes
...
#define PIN_PWM_U1          11                          //! P1.11
#define PIN_PWM_V1          10                          //! P3.10
#define PIN_PWM_W1          9                           //! P3.8
#define PIN_PWM_EN1         8                           //! P1.10

// IFX007 Board 2 refer as Y
#define PIN_PWM_U2          3                           //! P1.1
#define PIN_PWM_V2          5                           //! P2.12
#define PIN_PWM_W2          6                           //! P2.11
#define PIN_PWM_EN2         4                           //! P1.8

// IFX007 Board 3 refer as Z
#define PIN_PWM_U3          79                          //! P5.3
#define PIN_PWM_V3          80                          //! P5.5
#define PIN_PWM_W3          81                          //! P5.7
#define PIN_PWM_EN3         78                          //! P5.1

// IFX007 Board 4 refer as A
#define PIN_PWM_U4          66                          //! P0.6
#define PIN_PWM_V4          34                          //! P3.4
#define PIN_PWM_W4          36                          //! P0.3
#define PIN_PWM_EN4         35                          //! P0.5

// IFX007 Board 5 refer as CL
#define PIN_PWM_U5          77                          //! P1.15
#define PIN_PWM_V5          76                          //! P6.5
#define PIN_PWM_W5          88                          //! P6.4
#define PIN_PWM_EN5         87                          //! P6.6

// IFX007 Board 6 refer as CR
#define PIN_PWM_U6          89                          //! P6.2
#define PIN_PWM_V6          93                          //! P0.15
#define PIN_PWM_W6          94                          //! P0.12
#define PIN_PWM_EN6         92                          //! P3.3
